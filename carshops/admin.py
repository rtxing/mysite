...
class BookingAdmin(admin.ModelAdmin):
    list_display = ('id', 'shop__shop_name', 'customer__username', 'car__car_name', 'service__service_name', 'selected_slot','booking_status', "driver__phone",'created_at', 'booking_date')
